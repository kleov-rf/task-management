...
<template>
  <dialog class="absolute flex justify-center items-center inset-0 w-full h-full backdrop-blur-[2px] bg-black/25 z-10">
    <form class="w-96 flex flex-col gap-6 p-6 bg-white rounded-lg shadow-md">
      ...
      <section>
        ...
        <textarea id="description" name="description" v-model="description" rows="4" required
                  ...
                  placeholder="Write more details here..."></textarea>
      </section>

      <section>
        <label for="dueDate" class="block mb-2 text-sm font-medium text-gray-900">Due Date</label>
        <input
            type="date"
            required
            id="dueDate"
      ...
      <footer class="flex justify-end">
        ...
        <button type="submit" @click="handleCreateTask"
